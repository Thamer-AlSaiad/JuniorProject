...
class DIContainer {
  ...
  private initializeServices(): void {
    ...
    this.services.set('authApplicationService', new AuthApplicationService(this.get('authService')));
    this.services.set('userApplicationService', new UserApplicationService(this.get('userService')));
...
export const DI = {
  ...
  get authApplicationService() { return container.get<AuthApplicationService>('authApplicationService'); },
  get userApplicationService() { return container.get<UserApplicationService>('userApplicationService'); },
