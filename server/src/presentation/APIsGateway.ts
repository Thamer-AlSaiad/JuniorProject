...
router.get('/curriculum/lessons/:lessonId/content', DI.contentController.getRenderedContent);
...
router.get('/learning/lessons/:lessonId/raw-content', DI.contentController.getRawContent);
